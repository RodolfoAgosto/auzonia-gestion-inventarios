Public Class NotaDePedido
    ...
    Private _ListaDeArticulos As List(Of ArticuloNotaDePedido)
    Public Property ListaDeArticulos() As List(Of ArticuloNotaDePedido)
        Get
            Return _ListaDeArticulos
        End Get
        Set(ByVal value As List(Of ArticuloNotaDePedido))
    ...
    Public Sub New(ByVal pID As Integer, ByVal pFechaDeCreacion As Date, ByVal pEstado As String)
        Me.ID = pID
